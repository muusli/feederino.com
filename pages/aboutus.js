				...
				<Container>
					<Row className="row-grid justify-content-center">
						<Col className="text-center" lg="8">
							...
							<p className="lead">
								Egal ob du ein Rezept hochlädst. Die Autoren unterstützt. Feedback hast. Oder aktiv das
								Projekt mitgestalten willst. Jeder Beitrag zählt. Kontaktiere uns gerne, wir freuen uns
								über jede Nachricht.
							</p>
